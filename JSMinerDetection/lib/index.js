                    ...
                    return [4 /*yield*/, Promise.all(subdirs.map(function (subdir) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1: return [2 /*return*/, (_a.sent()).isDirectory() ? getFiles(res) : res];
                                }
                            });
                        }); }))];
                case 2:
...
var Crawler = /** @class */ (function () {
    ...
    Crawler.prototype.downloadFile = function (url, dest) {
        return __awaiter(this, void 0, void 0, function () {
            var fetchingLibrary;
            return __generator(this, function (_a) {
    ...
    Crawler.prototype.getFileInURL = function (url) {
                                ...
                                switch (_a.label) {
                                    ...
                                    case 6:
                                        setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                                            var workerWebAssemblyJson, _i, _a, x, workerObject, error_1;
                                            var _b;
    ...
    Crawler.prototype.main = function () {
        return __awaiter(this, void 0, void 0, function () {
            var page, windowWebAssemblyHandle, finish, cleanedURL, mkdirError_1, _i, _a, request, destination, downloadError_1;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    ...
                                    case 3:
                                        ...
                                        return [3 /*break*/, 4];
                                    case 4:
                                        if (!(this.webAssemblyWorkers.length > 0)) return [3 /*break*/, 11];
                                        _c.label = 5;
                                    case 5:
                    ...
                    case 2:
                        ...
                        // }, 30*1000 );
                        _b.sent();
                        return [4 /*yield*/, page.waitFor(12 * 1000)];
                    case 3:
                        _b.sent();
                    ...
                    case 4:
                        ...
                        cleanedURL = this.cleanURL(this.currentURL);
                        _b.label = 5;
                    case 5:
                        _b.trys.push([5, 7, , 8]);
                    ...
                    case 6:
                        ...
                        return [3 /*break*/, 8];
                    case 7:
                        mkdirError_1 = _b.sent();
                        if (mkdirError_1.code !== 'EEXIST') {
                            console.error(mkdirError_1);
                        }
                        return [3 /*break*/, 8];
                    case 8:
                        _i = 0, _a = this.capturedRequests[this.currentURL];
                        _b.label = 9;
                    case 9:
